...
const Arrow = ({ direction, onClick }) => {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('i', { className: directional })
  );
};
...
class CardCarousel extends _react.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_Arrow2.default, { direction: 'left', onClick: this.previousCard }),
      _react2.default.createElement(
        'div',
        { className: 'flashcard card' },
        _react2.default.createElement('div', { className: 'card-header bg-danger' }),
        _react2.default.createElement(
          'div',
          { className: 'card-body' },
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('i', { onClick: this.hideAnswer, className: 'show-answer text-danger fas fa-angle-double-down' }),
            showAnswer
          )
        )
      ),
      _react2.default.createElement(_Arrow2.default, { direction: 'right', onClick: this.nextCard }),
...
},{"../Indicators/Indicators":8,"./Arrow":1,"react":36}],3:[function(require,module,exports){
"use strict";
...
const EditForm = ({ editQuestionValue, editAnswerValue, onSubmit, onClick, onChange }) => _react2.default.createElement(
  "div",
  { className: "card-container card" },
  _react2.default.createElement(
    "div",
    { className: "new-card-form card-body" },
    _react2.default.createElement(
      "form",
      { className: "user-form", onSubmit: onSubmit },
      _react2.default.createElement(
        "h1",
        null,
        "Edit Flash Card"
      ...
      _react2.default.createElement(
        "button",
        { type: "submit", className: "btn-edit-save btn btn-large btn-success" },
        "Save Edit"
      ),
      _react2.default.createElement(
        "button",
        { onClick: onClick, type: "submit", className: "btn-edit-cancel btn btn-large btn-danger" },
        "Cancel"
      )
    )
  )
...
const FlashCard = ({ question, answer, edit, id, destroy }) => _react2.default.createElement(
  "div",
  { "data-id": id, className: "flashcard card" },
  _react2.default.createElement("div", { className: "card-header bg-danger" }),
  _react2.default.createElement(
    "div",
    { className: "card-body" },
    ...
    _react2.default.createElement("i", { onClick: edit, className: "fas fa-edit edit text-warning" }),
    _react2.default.createElement("i", { onClick: destroy, className: "far fa-trash-alt destroy text-danger" })
  )
);

exports.default = FlashCard;

},{"react":36}],5:[function(require,module,exports){
'use strict';
...
const FlashCards = ({ edit, onClick, data, destroy }) => {
  const cardData = [...data];
  let cards = _react2.default.createElement(_Empty2.default, { onClick: onClick });
  if (data.length) {
    cards = cardData.map((elem, index) => _react2.default.createElement(_FlashCard2.default, {
      id: index,
      edit: edit,
      key: index,
      destroy: destroy,
...
},{"../Form/Empty":6,"./FlashCard":4,"react":36}],6:[function(require,module,exports){
"use strict";
...
const Empty = ({ onClick }) => _react2.default.createElement(
  "div",
...
const Form = ({ view, value, onChange, onSubmit }) => _react2.default.createElement(
  "div",
  { className: "card-container card" },
  _react2.default.createElement(
    "div",
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "button",
        { type: "submit", className: "btn-save-card btn btn-success" },
        "Save"
      )
    )
  )
...
},{"react":36}],8:[function(require,module,exports){
'use strict';
...
const Indicators = props => _react2.default.createElement(
  'ul',
  { className: 'carousel-indicators' },
  props.data.map((card, index) => _react2.default.createElement(_Pip2.default, {
    key: index,
    index: index,
...
},{"./Pip":9,"react":36}],9:[function(require,module,exports){
"use strict";
...
const Pip = props => _react2.default.createElement(
  "li",
  null,
  _react2.default.createElement("a", {
    className: props.index === props.activeIndex ? "carousel-indicator carousel-indicator-active" : "carousel-indicator"
  })
);

exports.default = Pip;

},{"react":36}],10:[function(require,module,exports){
"use strict";
...
const Nav = props => {
  return _react2.default.createElement(
    "nav",
    { className: "navbar navbar-expand-lg navbar-light bg-light", id: "nav-container" },
    _react2.default.createElement(
      "div",
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            "Cards ",
            _react2.default.createElement("i", { className: "text-warning fas fa-sticky-note" })
          )
        ),
        _react2.default.createElement(
          "li",
          ...
          _react2.default.createElement(
            "a",
            { className: "nav-link", href: "#new" },
            "New ",
            _react2.default.createElement("i", { className: "text-success fas fa-plus-circle" })
          )
        ),
        _react2.default.createElement(
          "li",
          ...
          _react2.default.createElement(
            "a",
            { className: "nav-link", href: "#practice" },
            "Practice ",
            _react2.default.createElement("i", { className: "text-info fas fa-tasks" })
          )
        )
      )
    )
...
var _FlashCards = require('./FlashCard/FlashCards');

var _FlashCards2 = _interopRequireDefault(_FlashCards);

var _EditForm = require('./EditForm/EditForm');

var _EditForm2 = _interopRequireDefault(_EditForm);

var _CardCarousel = require('./CardCarousel/CardCarousel');

var _CardCarousel2 = _interopRequireDefault(_CardCarousel);
...
class App extends _react.Component {
  ...
  renderView() {
    ...
    let viewRender = null;
    if (state.view === "#new") {
      viewRender = _react2.default.createElement(_Form2.default, {
        view: state.view,
        value: state.data,
    ...
    if (state.view === "#cards") {
      viewRender = _react2.default.createElement(_FlashCards2.default, {
        edit: handleEdit,
    ...
    if (this.state.view === "#cards" && this.state.editIndex !== null) {
      viewRender = _react2.default.createElement(_EditForm2.default, {
    ...
    if (this.state.view === "#practice" && !this.state.data.length) {
      viewRender = _react2.default.createElement(_Empty2.default, { onClick: clickHandler });
    }
    if (this.state.view === "#practice" && this.state.data.length !== 0) {
      viewRender = _react2.default.createElement(_CardCarousel2.default, {
        data: state.data
      });
    }
    return viewRender;
  ...
  render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        'React Flash Cards',
        _react2.default.createElement('i', { className: 'text-danger fab fa-react' })
      ),
      _react2.default.createElement(
        'div',
...
},{"./CardCarousel/CardCarousel":2,"./EditForm/EditForm":3,"./FlashCard/FlashCards":5,"./Form/Empty":6,"./Form/Form":7,"./Nav/Nav":10,"react":36}],12:[function(require,module,exports){
'use strict';
...
},{"./app":11,"react":36,"react-dom":33}],13:[function(require,module,exports){
/**
...
},{"_process":28}],23:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":17,"_process":28}],27:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"fbjs/lib/ExecutionEnvironment":13,"fbjs/lib/containsNode":16,"fbjs/lib/emptyFunction":17,"fbjs/lib/emptyObject":18,"fbjs/lib/getActiveElement":19,"fbjs/lib/invariant":22,"fbjs/lib/shallowEqual":25,"object-assign":27,"react":36}],33:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":28,"fbjs/lib/emptyFunction":17,"fbjs/lib/emptyObject":18,"fbjs/lib/invariant":22,"fbjs/lib/warning":26,"object-assign":27,"prop-types/checkPropTypes":29}],35:[function(require,module,exports){
/** @license React v16.4.1
...
},{"fbjs/lib/emptyFunction":17,"fbjs/lib/emptyObject":18,"fbjs/lib/invariant":22,"object-assign":27}],36:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":34,"./cjs/react.production.min.js":35,"_process":28}]},{},[12]);
